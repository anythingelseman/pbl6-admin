    ...
    <div className="col-span-12 rounded-sm border border-[#e2e8f0] bg-white px-5 pt-8 pb-5 shadow-default sm:px-8 xl:col-span-7">
      <div className="flex flex-wrap items-start justify-between gap-3 sm:flex-nowrap">
        <div className="flex w-full flex-wrap gap-3 sm:gap-5">
          ...
          <div className="flex min-w-[12rem]">
            <span className="mt-1 mr-2 flex h-4 w-full max-w-[1rem] items-center justify-center rounded-full border border-[#80caee]">
              <span className="block h-2 w-full max-w-[0.625rem] rounded-full bg-[#80caee]"></span>
            </span>
            <div className="w-full">
              <p className="font-semibold text-[#80caee]">{series[1].name}</p>
        ...
        <div className="flex w-full max-w-[11rem] justify-end">
          ...
          {/*     onClick={() => setOption(2)} */}
          {/*     className={`rounded bg-white py-1 px-3 text-xs font-medium text-black ${ */}
          {/*       timeOption === 2 && "shadow-[0px_1px_3px_rgba(0,0,0,0.12)]" */}
          {/*     } hover:bg-white hover:shadow-[0px_1px_3px_rgba(0,0,0,0.12)]`} */}
          {/*   > */}
          {/*     Month */}
          {/*   </button> */}
